...
3. The combined image is shown at the bottom. The basic image is just have six images (they are three types of dogs and three black blocks with their names beside), and can be seem in this link ![my_meme_basicone.png](https://github.com/HOU-DTer/stats220/blob/main/my_meme_basicone.png)
